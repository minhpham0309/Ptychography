...
function [big_obj,aperture,fourier_error,initial_obj,initial_aperture] = RAAR_broadband(ePIE_inputs,varargin)
%varargin = {beta_ap, beta_obj, modeSuppression}
optional_args = {0.9, 0.9, 0, 1, 1 , 0.75, 0.4, 6, 0}; %default values for optional parameters
nva = length(varargin);
optional_args(1:nva) = varargin;
[beta_obj, beta_ap, modeSuppression, probe_norm, beta, w_init, w_final, order, semi_implicit_P] = optional_args{:};
rng('shuffle','twister');
...
step_size = [0.4 0.9 1 1 1 1 1 1 0.7 0.3];
