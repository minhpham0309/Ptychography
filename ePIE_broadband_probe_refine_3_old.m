%% same as probe_refine_2_norm but preallocated fresnel propagators 
function [big_obj,aperture,fourier_error,initial_obj,initial_aperture] = ePIE_broadband_probe_refine_3_old(ePIE_inputs,varargin)
...
filename = strcat('reconstruction_probe_replace_3_old',filename,'_',job_ID);
