...
function [big_obj,aperture,fourier_error,initial_obj,initial_aperture] = ePIE_broadband_probe_refine_3j(ePIE_inputs,varargin)
...
filename = strcat('reconstruction_probe_replace_3j',filename,'_',job_ID);
