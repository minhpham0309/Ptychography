%% probe replacement (jianhua method modified by arjun, with normalization)
function [big_obj,aperture,fourier_error,initial_obj,initial_aperture] = ePIE_broadband_probe_refine_2_norm(ePIE_inputs,varargin)
